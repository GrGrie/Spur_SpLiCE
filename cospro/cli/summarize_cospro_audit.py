"""Print a small go/no-go report for CoSpRo frozen-audit JSON files.
...
def summarize(path: Path) -> int:
    ...
    if null_failure:
        ...
        return 1
    print("GO_NO_GO=PROVISIONAL_GO run the one-seed CoSpRo control matrix; do not scale to multi-seed yet")
    return 0
