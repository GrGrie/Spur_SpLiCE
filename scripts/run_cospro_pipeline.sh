...
GRAPH_DEVICE="${GRAPH_DEVICE:-auto}"
NEIGHBOR_BACKEND="${NEIGHBOR_BACKEND:-auto}"
ANN_THRESHOLD="${ANN_THRESHOLD:-20000}"
ANN_TABLES="${ANN_TABLES:-8}"
ANN_BUCKET_SIZE="${ANN_BUCKET_SIZE:-512}"
...
pipeline_args=(
  ...
  --neighbor-backend "${NEIGHBOR_BACKEND}"
  --ann-threshold "${ANN_THRESHOLD}"
  --ann-tables "${ANN_TABLES}"
  --ann-bucket-size "${ANN_BUCKET_SIZE}"
