"""Build CRP teacher graphs from one concept-group artifact or a sweep directory."""
...
def _audit_name(config: CrpAuditConfig) -> str:
...
def main(argv: list[str] | None = None) -> None:
    ...
    for artifact_path in artifacts:
        ...
        output_directory = artifact_path.parent / "teacher_graphs" / _audit_name(config)
